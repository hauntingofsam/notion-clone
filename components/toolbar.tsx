        ...
        <div className="pl-[54px] group relative">
            {!!initialData.icon && !preview && (
                <div className="flex items-center gap-x-2 group/icon pt-6">
                    ...
                    <Button className="rounded-full opacity-0 text-muted-foreground group-hover/icon:opacity-100 transition text-xs" onClick={onremoveIcon} variant="outline" size="icon">
                        <X className="h-4 w-4"/>
