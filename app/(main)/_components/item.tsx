...
import { ChevronsDown, ChevronsRight, Divide, LucideIcon, MoreHorizontal, Trash } from "lucide-react";
...
export const Item=({
    ...
    return(
        ...
        className={cn("group min-h-[27px] py-1 text-sm pr-3 w-full hover:bg-primary/5 flex items-center text-muted-foreground font-medium",
